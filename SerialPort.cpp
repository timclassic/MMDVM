...
void CSerialPort::setMode(MMDVM_STATE modemState)
{
  switch (modemState) {
    ...
    case STATE_FMDSTARCAL:
      DEBUG1("Mode set to D-Star FM Calibrate (500Hz tone)");
      break;
    case STATE_P25CAL1K:
